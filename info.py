...
def is_enabled(value, default):
    return value.lower() in ["true", "yes", "1", "enable", "y"] if value else default
...
START_IMG = environ.get('START_IMG', 'https://i.ibb.co/v6fM0jWK.jpg').split()  # Ensure a direct image link
...
PORT = int(environ.get('PORT', '5000'))  # Convert PORT to integer
...
STREAM_MODE = is_enabled(environ.get('STREAM_MODE', 'True'), True)  # Corrected boolean conversion
...
SETTINGS = {
    ...
    'link': LINK_MODE,
    'is_verify': IS_VERIFY,
    'shortner_three': SHORTENER_WEBSITE
}
